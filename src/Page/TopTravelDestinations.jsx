        ...
        <div className='w-11/12 mx-auto my-10'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 grid-rows-2 gap-4'>
                ...
                <div className='row-span-2 col-span-6 grid grid-cols-1 md:grid-cols-6 gap-3 '>
                    ...
                    <div className='col-span-3 '>
                        <div className="relative w-full h-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            {/* Avatar Section */}
                            <img
                    ...
                    <div className='row-span-1 col-span-3'>
                        <div className="relative h-full w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            {/* Avatar Section */}
                            <img
                                className="object-cover object-center w-full h-full"
