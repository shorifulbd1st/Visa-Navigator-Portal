        ...
        <div className='w-11/12 mx-auto my-4 -mt-4'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 grid-rows-2 gap-4'>
                <div className='col-span-6 row-span-2'>
                    <div data-aos="fade-up" data-aos-duration="500" className="h-full relative bg-white rounded-lg shadow-lg">
                        {/* Avatar Section */}
                        <img
                        ...
                        <div className="w-full  px-6 py-3 fifty-off ">
                            <h1 className="mx-3 text-center text-2xl font-bold">Saudi Arabia</h1>
                        </div>
                ...
                <div className='row-span-2 col-span-6 grid grid-cols-1 md:grid-cols-6 gap-3 '>
                    <div className='col-span-3'>
                        <div data-aos="fade-up" data-aos-duration="500" className="relative w-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            {/* Avatar Section */}
                            <img
                            ...
                            <div className="w-full  px-6 py-3 fifty-off ">
                                <h1 className="mx-3 text-center text-2xl font-bold">Palestine</h1>
                            </div>

                        </div>
                    </div>
                    <div className='col-span-3 '>
                        <div data-aos="fade-up" data-aos-duration="500" className=" relative w-full h-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            {/* Avatar Section */}
                            <img
                            ...
                            <div className="w-full  px-6 py-3 fifty-off ">
                                <h1 className="mx-3 text-center text-2xl font-bold">Bangladesh</h1>
                            </div>
